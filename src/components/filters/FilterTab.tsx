...
export default function FilterTab({ active, onClick, label }: FilterTabProps) {
  return (
    <button
      onClick={onClick}
      className={cn(
        "relative flex flex-1 xl:flex-none items-center justify-center h-full px-1 sm:px-4 text-[12px] sm:text-[11px] font-black uppercase tracking-wider rounded-[6px] transition-all z-10 whitespace-nowrap overflow-hidden",
